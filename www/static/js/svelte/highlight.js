(function (global, factory) {
	...
	(global = global || self, global.highlight = factory());
	...
	var lang = {
	  castArray: castArray, clone: clone$1, cloneDeep: cloneDeep, cloneDeepWith: cloneDeepWith, cloneWith: cloneWith,
	...
	var object = {
	  assign: assign$1, assignIn: assignIn, assignInWith: assignInWith, assignWith: assignWith, at: at,
	...
	var util = {
	  ...
	  noop: noop$1, nthArg: nthArg, over: over, overEvery: overEvery, overSome: overSome,
	...
	function create_main_fragment(component, state) {
		...
		return {
			...
			h: function hydrate() {
				...
				select.className = "select-css span2";
