(function (global, factory) {
	...
	function create_main_fragment$1(component, state) {
		...
		var if_block = (state.visible) && create_if_block(component);
	...
	assign(BaseDropdown.prototype, proto);
	...
	function palette(ref) {
	    ...
	    return _unique(prepend.concat($themeData.colors.palette).concat(append));
	}
	...
	assign(ColorPicker.prototype, proto);
	...
	assign(ControlGroup.prototype, proto);
	...
	assign(CustomFormat.prototype, proto);
	...
	assign(BaseNumber.prototype, proto);
	...
	function create_main_fragment$b(component, state) {
		...
		var if_block_1 = (state.visible) && create_if_block_2$1(component);
		...
		return {
			...
			p: function update(changed, state) {
				...
				if (state.visible) {
					if (!if_block_1) {
						if_block_1 = create_if_block_2$1(component);
						if_block_1.c();
	...
	function create_main_fragment$c(component, state) {
		...
		var if_block = (state.hasHelp) && create_if_block$a(component);
		...
		return {
			...
			p: function update(changed, state) {
				if (state.hasHelp) {
					if (!if_block) {
						if_block = create_if_block$a(component);
						if_block.c();
						if_block.m(div, text);
					}
				} else if (if_block) {
	...
	assign(TextArea.prototype, proto);
	...
	assign(SelectAxisColumn.prototype, proto);
	...
	assign(TypeAhead.prototype, proto);
	...
	assign(Section.prototype, proto);
	...
	function create_main_fragment$i(component, state) {
		...
		var if_block = (!state.notoggle) && create_if_block$f();

		function click_handler(event) {
			component.toggle();
		}

		var if_block_1 = (state.open) && create_if_block_1$8(component);
		...
		return {
			...
			p: function update(changed, state) {
				...
				if (state.open) {
					if (!if_block_1) {
						if_block_1 = create_if_block_1$8(component);
						if_block_1.c();
						if_block_1.m(div, null);
					}
				} else if (if_block_1) {
	...
	function create_main_fragment$j(component, state) {
		...
		var if_block = (state.passed) && create_if_block$g();
	...
	assign(EditorNavStep.prototype, proto);
	...
	assign(EditorNav.prototype, proto);
